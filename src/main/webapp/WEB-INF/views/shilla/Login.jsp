				...
				<div class = "loginform">
					<div class = "logbtn">
						<div class = "radio divradio">
							<input id = "inhum" class = "radiowidth" type="radio" checked="checked" name = "bego">
							<label for = "inhum">회원</label>
						</div>
						<div class = "radio divradio">
							<input id = "inhum" class = "radiowidth" type="radio" name = "bego">
							<label for = "inhum">관리자</label>
						</div>
					</div>
								...
								<div class = "formbox">
									<div id = "idbox">
										<div class = "field">
											<div class = "inputform">
												<div class = "inputid">
													<input type = "text" class = "idinput" placeholder = "신라리워즈 번호 또는 아이디 입력">
												</div>
												<div class = "inputpw">
												...
												<div class = "loginbtn">
													<a href = "">
														<img src = "/css/Other/5login/loginbtn.gif">
													</a>
												</div>
											</div>
										</div>
										<div class = "downbtn">
											...
											<a class = "findid" href = "">신라리워즈 번호 또는 아이디 찾기</a>
