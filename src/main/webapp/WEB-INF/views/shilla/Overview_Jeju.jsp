...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Overview_Jeju</title>
		<link rel="stylesheet" href="/css/Hotel-Jeju.css">
...
<!--top -->
		...
		<div id = "div2">
			...
			<div id = "div2-1">
				...
				<div id = "div2-L">
					<div class = "contents">
						...
						<div class = "menu">
							...
							<a href = "/Overview_Jeju"><p class ="m-selected">제주신라호텔</p></a>
							<p class ="m"></p>
							<p class ="m"></p>
						</div>
					</div>
				...
				<!-- 우측 본문 부분 -->
				<div id = "div2-R">
					<div id = "div2-R-T">제주신라호텔
						<div id = "div2-R-T-R">
						Home > About the Shilla > <u class = "color">제주신라호텔</u>
						</div>
					</div>
					<div id = "div2-R-B">
						...
						<br>
						<br>
						<a id = "Jeju-link" href="http://www.shilla.net/jeju/index.do" target = "_blank"></a>
					</div>
				</div>
